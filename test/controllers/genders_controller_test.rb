...
class GendersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gender" do
    assert_difference('Gender.count') do
      post genders_url, params: { gender: { name: @gender.name, name_en: @gender.name_en, slug: @gender.slug } }
    end
  ...
  test "should update gender" do
    patch gender_url(@gender), params: { gender: { name: @gender.name, name_en: @gender.name_en, slug: @gender.slug } }
