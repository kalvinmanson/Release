...
class RanksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rank" do
    assert_difference('Rank.count') do
      post ranks_url, params: { rank: { comment: @rank.comment, paymment_id: @rank.paymment_id, rank: @rank.rank, user_id: @rank.user_id } }
    end
  ...
  test "should update rank" do
    patch rank_url(@rank), params: { rank: { comment: @rank.comment, paymment_id: @rank.paymment_id, rank: @rank.rank, user_id: @rank.user_id } }
